...
*/
const displayNames = [];
displayNames.push(zooAnimals.forEach( item => `Name: ${item.animal_name}, Scientific: ${item.scientific_name}`))
...
const popArray= zooAnimals.map(item=> item.population);

populationTotal = popArray.reduce( (total, num) => (total + num));
